...
def login(username: str, password: str):
    ...
    if user_id:
        return user_id, "Login berhasil!", gr.Tabs(selected="main-tab")
    return None, "Login gagal. Periksa username atau password.", None

def register(username: str, password: str):
    user_id = register_user(username, password)
    return user_id, f"Pengguna {username} berhasil dibuat!", gr.Tabs(selected="main-tab")
...
with gr.Blocks() as demo:
    ...
    with gr.Tab("Login", id="login-tab"):
        ...
        login_btn.click(login, inputs=[username_input, password_input], outputs=[user_id_state, login_status, demo])
        register_btn.click(register, inputs=[username_input, password_input], outputs=[user_id_state, login_status, demo])
    ...
    with gr.Tab("Main", id="main-tab", visible=False) as main_tab:
        with gr.Tab("Config"):
            ...
            save_btn.click(save_config, inputs=[user_id_state, criteria_input], outputs=config_status)
        ...
        with gr.Tab("Action"):
            ...
            review_btn.click(review_pdf, inputs=[user_id_state, pdf_input], outputs=review_output)
